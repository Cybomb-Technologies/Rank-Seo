...
export default function BillingPage() {
    ...
    try {
      ...
      if (auditResponse.ok) {
        ...
        const formattedAudits = (
          Array.isArray(auditData) ? auditData : auditData.audits || []
  ...
  const handleAutoRenewalToggle = async (enabled: boolean) => {
    try {
      ...
      const response = await fetch(
        `${API_BASE}/api/payments/auto-renewal/toggle`,
        {
          method: "POST",
          headers: {
  ...
  const handleDownloadInvoice = async (
    ...
    try {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = `RankSEO_Invoice_${planName.replace(
          /\s/g,
          "_"
        )}_${transactionId}.pdf`;
        ...
        alert(
          `Failed to download invoice. Server responded with: ${response.status} ${response.statusText}`
        );
      }
    } catch (error) {
  ...
  const isFreeTier =
    currentPlanName === "Free" || currentPlanName === "Free Tier";
            ...
            {userProfile ? (
                  ...
                  <p className="text-sm text-muted-foreground">
                    {hasActiveSubscription && userProfile.planExpiry ? (
                      <>
                        ...
                        <br />
                        {userProfile.autoRenewal &&
                          userProfile.nextRenewalDate && (
                            <>
                              Next renewal:{" "}
                              {formatDate(userProfile.nextRenewalDate)}
                            </>
                          )}
                      </>
                    ) : !isFreeTier ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-4">
                  You are currently on the Free Tier. Choose a plan to unlock
                  full features.
                </p>
          ...
          <CardContent>
            {usageStats ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Usage statistics will appear here once you start using our
                  features.
                </p>
        ...
        {hasActiveSubscription && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Automatically renew your subscription to avoid service
                interruption
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                <div className="space-y-1">
                  ...
                  {userProfile.renewalStatus && (
                    <p
                      className={`text-sm ${
                        userProfile.renewalStatus === "failed"
                          ? "text-destructive"
          ...
          <CardContent>
            {billingHistory.length > 0 ? (
                    ...
                    <div className="flex items-start sm:items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          {payment.billingCycle} • {payment.transactionId}
                        </p>
                        {payment.expiryDate && (
                          <p className="text-xs text-muted-foreground">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-4">
                  You haven't made any payments yet. Upgrade your plan to get
                  started.
                </p>
                <Button onClick={handleUpgrade}>View Plans</Button>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-2 justify-center">
                <Button
                  variant="outline"
                  onClick={() => window.open("mailto:info@rankseo.in")}
                >
                  Contact Support
                </Button>
